...
public class OpenAPIPhamacyTest01 {
	 public static void main(String[] args) throws IOException {
	        StringBuilder urlBuilder = 
	        		new StringBuilder("http://apis.data.go.kr/B551182/pharmacyInfoService/getParmacyBasisList"); /*URL*/
	        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=j5BLnIkTVGByDXUD4eCsG0TTK3BytEhFn1bQPADzQQ654MElDkkXyMFY4dAh9SVoyqR6LcOkDg6EC7cy8s4wSQ%3D%3D"); /*Service Key*/
