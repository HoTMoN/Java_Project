...
public class CH_WrapperTest {
	...
	private static void run(Object obj) {
		...
		//5.0이후
		//오토언박싱
		//int형 변수에 참조형으로 변환된 값을 전달하는 경우 컴파일러가 자동으로 객체로 포장된 값을 풀어서 기본형으로 변환해준다.
		int i = (Integer)obj;
		
		System.out.println("5.0이전버젼에서 변환=>"+num);
		System.out.println("5.0이전버젼에서 변환=>"+i);
