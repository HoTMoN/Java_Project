...
public class FileTest01 {
	...
	public static void main(String[] args) {
		//엑세스하고 싶은 파일이나 폴더의 위치를 File객체를 만들때 매개변수로 정의
		...
		System.out.println("file1.idDirectory()=>"+file1.isDirectory());
		...
		String dataStr = sdf.format(file3.lastModified());
		System.out.println("마지막 변경 날짜:"+dataStr);
		System.out.println("file3.length()=>"+file3.length());
		file3.setReadOnly(); //Read만 가능하도록 Write가 false로 바뀜
	}
