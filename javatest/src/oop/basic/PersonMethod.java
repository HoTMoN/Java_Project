...
public class PersonMethod {
	...
	//name 변수에 private으로 외부에서 접근불가로 설정되었기 때문에 public메소드를 통해 값을 셋팅하고 값을 전달할 수 있도록 정의한다.
	//name 변수에 값을 셋팅하는 메소드 - setter메소드
	...
	//name 변수에 저장된 값을 읽을 수 있는 메소드(읽어서 호출하는 곳으로 보내줄 수 있는 메소드) - getter메소드
