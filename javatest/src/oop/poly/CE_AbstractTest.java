 ...
 * *내용이 정의되지 않은 메소드를 갖고 잇는 클래스(추상 메소드(body가 없는 메소드))
 * 1) 추상메소드를 선언하는 방법
 ...
 *    그러므로 Sub가 추상메소드를 갖고 있는 클래스가 되므로
 *    
 *    [해결방법]
 *    1. 하위클래스에 선언부에 abstract을 추가해서 추상클래스로 정의한다.
 *    2. 상속받은 abstract클래스의 abstract메소드를 오버라이딩 해서 정의해주어야 한다. 
*/
