...
//FileNotFoundException, IOException은 호출되는 곳에서 예외에 대한 예외를 처리하지 않으면 문법오류가 발생되어 컴파일이 되지 않는다
...
public class CG_ExceptionTest05 {
	public static void main(String[] args) {
		//FileReader가 FileNotFoundException을 throws하고 있다는 것은 내부에서 예외를 직접 처리
		//하지 않고 호출하는 곳에서 예외를 처리하라는 의미
		try{
