...
public class StockMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
	...
	// 입력 데이터로 line하나가 전달되고 line하나를 어떻게 처리할 것인지 명시
